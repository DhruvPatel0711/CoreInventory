...
router.get('/', auth_middleware_1.authenticate, inventoryController.listInventory);
router.get('/:productId', auth_middleware_1.authenticate, inventoryController.getProductInventory);
