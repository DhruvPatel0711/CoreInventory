...
exports.listTransfers = exports.createTransfer = void 0;
const asyncHandler_1 = require("../utils/asyncHandler");
const ApiError_1 = require("../utils/ApiError");
const movementService = __importStar(require("../services/movement.service"));
// ─── POST /api/transfers — Move stock between locations ──────
exports.createTransfer = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (!productId || !fromLocationId || !toLocationId || !quantity) {
        throw new ApiError_1.ApiError(400, 'productId, fromLocationId, toLocationId, and quantity are required');
    }
...
exports.listTransfers = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
