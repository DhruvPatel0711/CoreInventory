...
exports.listDeliveries = exports.createDelivery = void 0;
...
exports.createDelivery = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { productId, fromLocationId, quantity, reference, notes } = req.body;
    if (!productId || !fromLocationId || !quantity) {
        throw new ApiError_1.ApiError(400, 'productId, fromLocationId, and quantity are required');
    }
...
exports.listDeliveries = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
